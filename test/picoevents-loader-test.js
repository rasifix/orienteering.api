...
var parseCsv = require("../services/picoevents-loader").parseCsv;

var data = `BasicData,ZUG2025,"79. Zuger OL",2025-09-21,08:00:00,Einzel,Rotkreuz,"Sijentalwald - Rotkreuz","OLV Zug"
...
describe("Live Events", function () {
  describe("Parse", function () {
    it("should properly parse runners", function () {
      var event = parseCsv(data);
